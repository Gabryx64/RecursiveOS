...
static uint8_t font[][8] =
{
    ...
    { 0x00, 0x00, 0x3C, 0x66, 0x06, 0x66, 0x3C, 0x00 },     // U+0063 (c)
    ...
    { 0x7E, 0x5A, 0x5A, 0x18, 0x18, 0x18, 0x3C, 0x00 },     // U+0372 (archaic Sampi)
    { 0x7C, 0x5A, 0x18, 0x18, 0x18, 0x18, 0x18, 0x00 },     // U+0373 (archaic sampi)
    { 0x60, 0x60, 0x30, 0x00, 0x00, 0x00, 0x00, 0x00 },     // U+0374 (greek numeral sign)
    { 0x00, 0x00, 0x00, 0x00, 0x00, 0x60, 0x30, 0x30 },     // U+0375 (greek lower numeral sign)
    { 0x63, 0x73, 0x7B, 0x6F, 0x67, 0x63, 0x63, 0x00 },     // U+0376 (Pamphylian Digamma)
    { 0x00, 0x00, 0x26, 0x34, 0x3C, 0xAC, 0x64, 0x00 },     // U+0377 (pamphylian digamma)
    { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },     // U+0378
    { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },     // U+0379
    { 0x00, 0x00, 0x00, 0x00, 0x00, 0x30, 0xB0, 0x60 },     // U+037A (Ypogegrammeni)
    { 0x00, 0x00, 0x3C, 0x66, 0x60, 0x66, 0x3C, 0x00 },     // U+037B (reversed lunate sigma)
    { 0x00, 0x00, 0x3C, 0x66, 0x16, 0x66, 0x3C, 0x00 },     // U+037C (dotted lunate sigma)
    { 0x00, 0x00, 0x3C, 0x66, 0x68, 0x66, 0x3C, 0x00 },     // U+037D (reversed dotted lunate sigma)
    { 0x00, 0x0C, 0x0C, 0x00, 0x00, 0x0C, 0x0C, 0x06 },     // U+037E (greek question mark)
    { 0x78, 0x30, 0x30, 0x30, 0x33, 0x33, 0x1E, 0x00 },     // U+037F (Yot)
    { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },     // U+0380
    { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },     // U+0381
    { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },     // U+0382
    { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },     // U+0383
    { 0x40, 0x60, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00 },     // U+0384 (tonos)
    { 0x40, 0x60, 0x20, 0x50, 0x00, 0x00, 0x00, 0x00 },     // U+0385 (dialytika tonos)
    { 0x32, 0x7B, 0xCD, 0xCC, 0xFC, 0xCC, 0xCC, 0x00 },     // U+0386 (Alpha with tonos)
    { 0x00, 0x00, 0x00, 0x18, 0x18, 0x00, 0x00, 0x00 },     // U+0387 (ano teleia)
    { 0xFE, 0x8F, 0x2D, 0x3C, 0x2C, 0x8C, 0xFE, 0x00 },     // U+0388 (Epsilon with tonos)
    { 0xCE, 0xCF, 0xCD, 0xFC, 0xCC, 0xCC, 0xCC, 0x00 },     // U+0389 (Eta with tonos)
    { 0x7A, 0x33, 0x31, 0x30, 0x30, 0x30, 0x78, 0x00 },     // U+038A (Iota with tonos)
    { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },     // U+038B 
    { 0x3A, 0x6F, 0xC7, 0xC6, 0xC6, 0x6C, 0x38, 0x00 },     // U+038C (Omicron with tonos)
    { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },     // U+038D 
    { 0xCE, 0xCF, 0xCD, 0x78, 0x30, 0x30, 0x78, 0x00 },     // U+038E (Upsilon with tonos)
    { 0x7E, 0xC7, 0xC7, 0xC6, 0xEE, 0x6C, 0xEE, 0x00 },     // U+038F (Omega with tonos)
    { 0x2D, 0x00, 0x0C, 0x0C, 0x0C, 0x2C, 0x18, 0x00 },     // U+0390 (iota with dialytika tonos)
    ...
    { 0x33, 0x00, 0x1E, 0x0C, 0x0C, 0x0C, 0x1E, 0x00 },     // U+0399 (Iota with dialytika)
    { 0x33, 0x00, 0x33, 0x33, 0x1E, 0x0C, 0x1E, 0x00 },     // U+03A5 (Upsilon with dialytika)
    ...
    { 0x2D, 0x00, 0x33, 0x33, 0x33, 0x33, 0x1E, 0x00 },     // U+03B0 (upsilon with dialytika tonos)
	...
	// TODO: implement characters U+30A0-U+E540
    [0xE541] =
